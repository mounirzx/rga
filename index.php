          ...
          >
            <div class="col">
              ...
              <!-- <div style="text-align: center; width: 420px; margin-top: 30px">
                ...
                <br />
                <h5>
                  Recensement <br />Général de l'Agriculture <br />
                  <br />
                  2024
                </h5>
                <br />
...
<br/><br />
                ...
                <div class="container-login100-form-btn">
                  <button type="submit" class="login100-form-btn" id="login">
                    ...
                    ></i>
                    <!-- Replace "fa-sign-in" with the class of your desired login icon -->
                    <b style="color: aliceblue">Se connecter</b>
                  </button>
                </div>

                <div data-tilt style="margin-left: 20px; margin-top: 103px">
                  <img style="width: 60px" src="static/logo2.png" alt="IMG" />
                </div>
              </form>
            </div>
          </div>
