$(document).ready(function () {
 ...
 // Initialize an empty array to store superficie data
 
var formDataArraySuperficie = [];

// Loop over each element with the class .superficie
$(".superficie").each(function () {
  // Initialize an object to store superficie data for the current element
  var superficieObj = {};
  superficieObj["name"] = this.name;
  superficieObj["value"] = $(this).val();
  
  // Push the superficieObj to the formDataArraySuperficie
  formDataArraySuperficie.push(superficieObj);
});
    ...
    $(function () {
      $.ajax({
        ...
        data: JSON.stringify({
          ...
          formDataArraySuperficie: formDataArraySuperficie // Include formDataArraySuperficie here
