...
if (isset($_GET['id']) && is_numeric($_GET['id'])) { // Check if 'id' is provided and is a number
    ...
    try {
        ...
        $stmt_sj = $bdd->prepare("
        SELECT id_status_juridique,cle_status_juridique, origine_des_terres, status_juridique, superfecie_sj, superfecie_sj_are
        ...
        $stmt_ma = $bdd->prepare("
        SELECT id_materiel_agricol,cle_materiel_agricole, code_materiel, code_materiel_nombre, ee_mode_mobilisation_materiel, ee_mode_exploitation_materiel
        ...
        SELECT id,cle_code_culture, code_culture, superficie_hec, superficie_are, en_intercalaire
